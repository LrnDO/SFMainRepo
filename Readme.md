...
Сто раз чиню косяки в докерфайле, и пушу его гитхаб, запуская сборку. Убеждаюсь, что образ появляется в докерхабе,
а затем гитхаб по ссш вламывается на SRV и разворачивает образ на мой кластер k8s

подготавливаем мониторинг - на SRV ставим докер и докер композ
sudo apt update
